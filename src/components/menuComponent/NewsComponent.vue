<template>
  ...
  <div class="tw-h-full tw-w-full tw-flex tw-flex-col tw-items-center tw-p-6 tw-mt-40">
    <div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-6 tw-w-full tw-max-w-6xl">
      <div class="tw-grid tw-grid-cols-2 tw-gap-4">
        <div
          ...
          class="tw-p-6 tw-bg-secondary tw-rounded-lg tw-shadow-md hover:tw-shadow-lg hover:tw-scale-105 tw-transition-all"
        >
      ...
      <div>
        <div class="tw-flex tw-flex-col tw-justify-center tw-items-center tw-bg-secondary tw-rounded-lg tw-shadow-md tw-p-6 tw-mb-4">
        ...
        <div class="tw-grid tw-grid-cols-2 tw-gap-4">
          ...
          >
            <q-img
              ratio="2"
              fit="contain"
              src="assets/icons/monday.png"
              alt="parallax1"
              class="tw-rounded-2.5xl"
            />
          </div>
          <div
            class="tw-p-6 tw-bg-secondary tw-rounded-lg tw-shadow-md hover:tw-shadow-lg hover:tw-scale-105 tw-transition-all"
          >
            <q-img
              ratio="2"
              fit="contain"
              :src="'assets/icons/comCompanyIcon.jpg'"
              alt="parallax1"
              class="tw-rounded-2.5xl"
            />
          </div>
